...
- (void)config {
	...
	UIImageView *topLine = [[UIImageView alloc] initWithFrame:CGRectMake(0, -5, kAppScreenWidth, 5)];
...
- (void)setTabBarItemAttributes:(NSArray<NSDictionary *> *)tabBarItemAttributes {
    ...
    CGFloat normalItemWidth = (kAppScreenWidth * 3 / 4) / (_tabBarItemAttributes.count - 1);
    CGFloat tabBarHeight = CGRectGetHeight(self.frame);
    CGFloat publishItemWidth = (kAppScreenWidth / 4);
